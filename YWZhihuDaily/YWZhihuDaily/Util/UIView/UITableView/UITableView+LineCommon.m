...
#import "UITableView+LineCommon.h"
#import "UIColor+YWExtension.h"
@implementation UITableView (LineCommon)
...
- (void)addLineforPlainCell:(UITableViewCell *)cell forRowAtIndexPath:(NSIndexPath *)indexPath withLeftSpaceAndSectionLine:(CGFloat)leftSpace{
    ...
    CGColorRef lineColor = [UIColor colorWithString:@"0xdddddd"].CGColor;
