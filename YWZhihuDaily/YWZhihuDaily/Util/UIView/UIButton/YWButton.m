...
- (void)setEdgeInsetsStyle:(YWButtonEdgeInsetsStyle)edgeInsetsStyle {
    ...
    switch (edgeInsetsStyle) {
        case YWButtonEdgeInsetsStyleImageRight:
        {
            space = space * 0.5;
        ...
        case YWButtonEdgeInsetsStyleImageLeft:
        {
            space = space * 0.5;
            ...
            break;
        case YWButtonEdgeInsetsStyleImageBottom:
        {
            ...
            break;
        case YWButtonEdgeInsetsStyleImageTop:
        {
            CGFloat imageHeight = CGRectGetHeight(self.imageView.frame);
            CGFloat labelHeight = CGRectGetHeight(self.titleLabel.frame);
            CGFloat buttonHeight = CGRectGetHeight(self.frame);
